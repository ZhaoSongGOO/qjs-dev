...
JSIApp::JSIApp(JSContext *ctx) : ctx_(ctx) { ensureInitialized(ctx); }
...
JSValue JSIApp::getAdapter(JSContext *ctx, JSValue obj, JSAtom prop,
                           JSValue receiver) {
...
int JSIApp::setAdapter(JSContext *ctx, JSValue obj, JSAtom prop, JSValue value,
...
void JSIApp::ensureInitialized(JSContext *context) {
  ...
  static JSClassDef class_def = {.class_name = "_native",
